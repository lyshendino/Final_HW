...
class MapViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        geoCoder.geocodeAddressString(viewpoint.location ?? "", completionHandler: { placemarks, error in
            if let error = error {
                print(error)
                return
            }
            ...
            if let placemarks = placemarks {
                ...
                annotation.title = self.viewpoint.name
                annotation.subtitle = self.viewpoint.type
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        if let viewpointImage = viewpoint.image {
            leftIconView.image = UIImage(data: viewpointImage as Data)
        }
